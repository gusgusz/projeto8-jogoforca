const palavras = [
    "abacate", "abacaxi", "abelha", "abanador", "antologia", "amor", "aba", "abraco", "ábaco", "abrigo", "abrir", 
    "banana", "boi", "batata", "bacalhau", "bexiga", "bowl", "batedeira", "bisturi", "barreira", "banco", 
    "caixa", "chantilly", "comércio", "cachorro", "cuidado", "caneta", "carinho", "cabra", "cesto", 
    ...
    "laranja", "lua", "leão", "limão", "larápio", "luz", "lindo", "lacraia", "lactose", "lacrar", 
    "mamão", "manga", "morango", "mico", "matar", "mingau", "moqueca", "macacão", "mocassin", 
    ...
    "pato", "polvo", "povoar", "pólvora", "paróqia", "pano", "princesa", "pizza", "patroa", 
    ...
    "tatu", "tabacaria", "taberneiro", "tábua", "torrada", "três", "tamanho", "tatuagem", "trem", 
